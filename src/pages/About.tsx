      ...
      <div className="max-w-7xl mx-auto px-6 mb-24">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-slate-400 leading-relaxed">
            Founded in 2012, Nexus Digital started with a simple mission: to help businesses leverage technology to achieve their full potential. Today, we are a global team of designers, developers, and strategists.
          </p>
        </div>
      </div>
