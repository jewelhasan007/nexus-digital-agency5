...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { 
      ...
      path: '/services',
      subMenu: [
        { name: 'Website Design', path: '/services/website-design', icon: Monitor },
        { name: 'Landing Page Design', path: '/services/landing-page', icon: Layout },
        { name: 'Logo Design', path: '/services/logo-design', icon: PenTool },
        { name: 'Digital Marketing & SEO', path: '/services/seo', icon: BarChart },
        { name: 'Amazon FBA Product Research', path: '/services/amazon-fba', icon: PackageSearch },
      ]
    },
